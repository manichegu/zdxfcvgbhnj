  ...
  async function submit(e){
    ...
    try{
      ...
      .then(res=>{
        ...
        else if(res.data==="please enter email!!"){
          alert("enter email!!");
        }
        else {
          alert("user is not sign up!!");
...
<div className="session">
        ...
        <form action="post" className="log-in" autoComplete="off"> 
          ...
          <div className="floating-label">
            <input required placeholder="Email" type="email" name="email" id="email" autoComplete="off" onChange={(e)=>{setEmail(e.target.value)}}  />
          ...
          <div className="floating-label">
            <input required placeholder="Password" type="password" name="password" id="password" autoComplete="off" onChange={(e)=>{setPassword(e.target.value)}} />
